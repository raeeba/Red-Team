...
define('ATLEAST_1_SPECIAL_CHARACTER','Include a minimum of one special character');
define('ENTER_NEW_PASSWORD','Enter new password');
define('CONFIRM NEW PASSWORD','Confirm new password');
...
define("EMPLOYEE_MANAGER","Employee Management");
